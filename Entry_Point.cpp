...
__int32 __stdcall DllMain(HMODULE This_Module, unsigned __int32 Call_Reason, void* Reserved)
{
    ...
    else
    {
        if (Call_Reason == DLL_PROCESS_ATTACH)
        {
            ...
            {
                Redirection_Manager::Redirect_Function(Original_Fire_Bullet_Caller, 1, (void*)0x241CF422, 1, (void*)Redirected_Fire_Bullet);
                Byte_Manager::Set_Bytes(1, (void*)((unsigned __int32)LoadLibraryW(L"vaudio_speex.dll") + 9360), 1, 195);
                AllocConsole();
                SetConsoleTitleW(L"noobhack");
                ...
                _putws(L"[ + ] Events");
                {
                    ...
                    *(void**)Event_Listener = Event_Listener_Table;
                    ...
                    Add_Listener_Type(537586416)((void*)540812808, Event_Listener, (char*)"round_start", nullptr);
                ...
                _putws(L"[ + ] Materials");
                {
                    ...
                    Redirection_Manager::Redirect_Function(Original_Draw_Model, 3, (void*)0x2C002D40, 1, (void*)Draw_Model);
