...
Interface_Structure Interface_Kill_Say;
...
void Implement_Extended_Interface()
{
	...
	Create_Interface(Pointer_Name(Interface_Uber_Alles_Scale), (char*)"0", nullptr);

	Create_Interface(Pointer_Name(Interface_Uber_Alles_Speed), (char*)"0", nullptr);
	...
	Create_Interface(Pointer_Name(Interface_Kill_Say), (char*)"1", nullptr);
