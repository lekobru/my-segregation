...
Interface_Structure Interface_Autowall;
...
void Implement_Extended_Interface()
{
	...
	Create_Console_Interface(Pointer_Name(Interface_Bruteforce_Memory_Tolerance), (char*)"3", (void*)Bruteforce_Reset_Memory_Tolerance);
	...
	Create_Console_Interface(Pointer_Name(Interface_Bruteforce_Angles), (char*)"-89, 89, -25, 25, 0", (void*)Bruteforce_Set_Angles);
	...
	Create_Console_Interface(Pointer_Name(Interface_Second_Choked_Angle_Y), (char*)"143", nullptr);

	Create_Console_Interface(Pointer_Name(Interface_Angle_Y), (char*)"180", nullptr);

	Create_Console_Interface(Pointer_Name(Interface_Simulation_Height), (char*)"0", nullptr);

	Create_Console_Interface(Pointer_Name(Interface_Simulation_Ticks), (char*)"16", nullptr);

	Create_Console_Interface(Pointer_Name(Interface_Simulation_Rotation_Divisor), (char*)"45", nullptr);

	Create_Console_Interface(Pointer_Name(Interface_Jitter_Range), (char*)"0", nullptr);

	Create_Console_Interface(Pointer_Name(Interface_At_Targets), (char*)"1", nullptr);

	Create_Console_Interface(Pointer_Name(Interface_Chams), (char*)"1", nullptr);

	Create_Console_Interface(Pointer_Name(Interface_Autowall), (char*)"1", nullptr);

	Create_Console_Interface(Pointer_Name(Interface_Extrapolation), (char*)"1", nullptr);

	Create_Console_Interface(Pointer_Name(Interface_Enemy_Check), (char*)"1", nullptr);
}